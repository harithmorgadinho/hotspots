...
p = ggplot()+geom_bar(data = df_plot,aes(y = biomes, x = value, fill = variable),
  ...
  annotate(geom = 'text',y = 14.5,x = df_plot$value[26]+4,label = '410 thousand sqkm',family = myfont,size = 2)+
  annotate(geom = 'text',y = 14.5,x =  df_plot$value[11]+5,label = '73 million people',family = myfont,size = 2)+
  annotate(geom = 'text',y = 13.5,x = df_plot$value[29]+4,label = '1 million sqkm',family = myfont,size = 2)+
  annotate(geom = 'text',y = 13.5,x =  df_plot$value[14]+5,label = '1.8 billion people',family = myfont,size = 2)+
  annotate(geom = 'text',y = 12.5,x = df_plot$value[19]+4,label = '772 thousand sqkm',family = myfont,size = 2)+
  annotate(geom = 'text',y = 12.5,x =  df_plot$value[4]+5,label = '65 million people',family = myfont,size = 2)+
  annotate(geom = 'text',y = 11.5,x = df_plot$value[27]+4,label = '1.7 million sqkm',family = myfont,size = 2)+
  annotate(geom = 'text',y = 11.5,x =  df_plot$value[12]+5,label = '194 million people',family = myfont,size = 2)+
  annotate(geom = 'text',y = 10.5,x = df_plot$value[20]+4,label = '1 million sqkm',family = myfont,size = 2)+
  annotate(geom = 'text',y = 10.5,x =  df_plot$value[5]+5,label = '138 million people',family = myfont,size = 2)+
  annotate(geom = 'text',y = 9.5,x = df_plot$value[21]+4,label = '840 thousand sqkm',family = myfont,size = 2)+
  annotate(geom = 'text',y = 9.5,x =  df_plot$value[6]+5,label = '45 million people',family = myfont,size = 2)+
annotate(geom = 'text',y = 8.5,x = df_plot$value[23]+7,label = '312 million people / 1.7 million sqkm',family = myfont,size = 2)+
  annotate(geom = 'text',y = 7.5,x = df_plot$value[24]+10,label = '18 million people / 302 thousand sqkm',family = myfont,size = 2)+
  annotate(geom = 'text',y = 6.5,x = df_plot$value[13]+13,label = '87 million people / 1 million sqkm',family = myfont,size = 2)+
  annotate(geom = 'text',y = 5.5,x = df_plot$value[17]+10,label = '101 million people / 1.2 million sqkm',family = myfont,size = 2)+
  annotate(geom = 'text',y = 4.5,x = df_plot$value[25]+10,label = '22 million people / 410 thousand sqkm',family = myfont,size = 2)+
  annotate(geom = 'text',y = 3.5,x = df_plot$value[18]+10,label = '8 million people / 38 thousand sqkm',family = myfont,size = 2)+
  annotate(geom = 'text',y = 2.5,x = df_plot$value[15]+10,label = '47 thousand people / 308 thousand sqkm',family = myfont,size = 2)+
