...
ids_any_threat_no_cc = sort(unique(c(ids_hunting,ids_agriculture,ids_logging,ids_pollution,ids_invasives,ids_urbanization)))
y = ids_any_threat_no_cc
probability_any_threat <- unlist(lapply(x, FUN = weight_layer,y = y))

max(na.omit(probability_any_threat))

r_grid$any_threat_no_cc_a = probability_any_threat
...
r_grid$any_threat_no_cc_r = probability_any_threat

hist(r_grid$any_threat_no_cc_r)
...
y = ids_any_threat_no_cc
probability_any_threat <- unlist(lapply(x, FUN = weight_layer,y = y))
hist(probability_any_threat)

r_grid$any_threat_no_cc_m = probability_any_threat
...
r_grid$any_threat_no_cc_b = probability_any_threat

hist(r_grid$any_threat_no_cc_b)

save(r_grid,file = 'r_grid_any_threat_no_cc.Rdata')
