...
realm_list = unique(na.omit(realm_list))
...
# p = ggplot()+
#   geom_sf(data = r_grid,aes(fill = as.factor(wege2_a_d_NEW_REALM),col = as.factor(wege2_a_d_NEW_REALM)))
# 
# ggsave(filename = 'p_test.png')
...
save(r_grid,file = 'r_grid_metrics_run2_deciles_wallace_nov28.Rdata')
...
theme_harith = theme(legend.position = c(0.96,0.81),
...
p_1 = ggplot()+
  geom_sf(data = background_r_grid_summ,bg = 'lightblue',col = 'black',linewidth = 0.05)+
  geom_sf(data = sf_land_low_res,bg = 'grey90',linewidth = 0.05,col = 'grey90')+
...
p_4 = ggplot()+
  geom_sf(data = background_r_grid_summ,bg = 'lightblue',col = 'black',linewidth = 0.05)+
  #geom_sf(data = r_grid[r_grid$land==1,],bg = 'grey75',linewidth = 0.05,col = 'grey75')+
  geom_sf(data = sf_land_low_res,bg = 'grey90',linewidth = 0.05,col = 'grey90')+
...
# 
# 
# ggsave(filename = 'cum_threats_NEW_REALM.png',plot = grid,width = 10,height = 5,dpi = 500)
...
p_all = ggplot()+
  geom_sf(data = background_r_grid_summ,bg = 'lightblue',col = NA,linewidth = 0.1)+
  #geom_sf(data = r_grid[r_grid$land==1,],bg = 'grey90',linewidth = 0.05,col = 'grey90')+
  geom_sf(data = sf_land_low_res,bg = 'grey90',linewidth = 0.05,col = 'grey90')+
  geom_sf(data = CMEC_newrealms,col = 'black',linewidth = 0.1,fill = 'grey80')+
  # geom_sf(data = CMEC_newrealms[1,],col = alpha(pal_wallace[1],1),linewidth = 1,fill = NA)+
  # geom_sf(data = CMEC_newrealms[2,],col = alpha(pal_wallace[2],1),linewidth = 1,fill = NA)+
  # geom_sf(data = CMEC_newrealms[3,],col = alpha(pal_wallace[3],1),linewidth = 1,fill = NA)+
  # geom_sf(data = CMEC_newrealms[4,],col = alpha(pal_wallace[4],1),linewidth = 1,fill = NA)+
  # geom_sf(data = CMEC_newrealms[5,],col = alpha(pal_wallace[5],1),linewidth = 1,fill = NA)+
  # geom_sf(data = CMEC_newrealms[6,],col = alpha(pal_wallace[6],1),linewidth = 1,fill = NA)+
  # geom_sf(data = CMEC_newrealms[7,],col = alpha(pal_wallace[7],1),linewidth = 1,fill = NA)+
  # geom_sf(data = CMEC_newrealms[8,],col = alpha(pal_wallace[8],1),linewidth = 1,fill = NA)+
  # geom_sf(data = CMEC_newrealms[9,],col = alpha(pal_wallace[9],1),linewidth = 1,fill = NA)+
  # geom_sf(data = CMEC_newrealms[10,],col = alpha(pal_wallace[10],1),linewidth = 1,fill = NA)+
  # geom_sf(data = CMEC_newrealms[11,],col = alpha(pal_wallace[12],1),linewidth = 1,fill = NA)+
...
ggsave(filename = 'cum_threats_all_NEW_REALM.png',plot = p_all,width = 12,height = 8,dpi = 2000)
# 
...
ggsave(filename = 'Figure1_1500_NEWREALMS.png',plot = combined_plot,width = 12,height = 14,dpi = 1500)
...
ggsave('inset_wallace.png',width = 5,height = 3,dpi = 500,plot = p)  
